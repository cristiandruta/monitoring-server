 ...
 *     curl -i http://mf.excess-project.eu:3030/v2/dreamcloud/mf/runtime/ms2/t2.1/AVZ-5cqVGYwmTvCuSqZC
 *
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://mf.excess-project.eu:3030/v2/dreamcloud/mf/runtime/ms2/AVZ-5cqVGYwmTvCuSqZC
 *
 * @apiSuccess {String} start start timestamp of the experiment
 * @apiSuccess {String} end end timestamp of the experiment
