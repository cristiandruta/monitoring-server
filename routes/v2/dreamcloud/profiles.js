 ...
 *     curl -i http://mf.excess-project.eu:3030/v2/dreamcloud/mf/profiles/ms2
 *
...
router.get('/:workflowID', function(req, res, next) {
    ...
    res.redirect('/v2/mf/profiles/' + wID + '?dreamcloud');
});
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://mf.excess-project.eu:3030/v2/dreamcloud/mf/profiles/ms2/t2.1
 *
...
router.get('/:workflowID/:taskID', function(req, res, next) {
    ...
    res.redirect('/v2/mf/profiles/' + wID + '/' + tID + '?dreamcloud');
});
 ...
 *
 * @apiExample {curl} Example usage:
 *     curl -i http://mf.excess-project.eu:3030/v2/dreamcloud/mf/profiles/ms2/t2.1/AVQ-MczMGMPeuCn4FHqi
 *
...
router.get('/:workflowID/:taskID/:experimentID', function(req, res, next) {
    ...
    res.redirect('/v2/mf/profiles/' + wID + '/' + tID + '/' + eID);
});
